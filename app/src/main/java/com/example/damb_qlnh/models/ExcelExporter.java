...
public class ExcelExporter {
    ...
    public void setInfo(String maHD, String maKH, String tenKH, String ngTT){
        Row headerRow = sheet.createRow(0);
        headerRow.createCell(0).setCellValue("Mã hóa đơn");
        headerRow.createCell(1).setCellValue(maHD);
        ...
        headerRow.createCell(1).setCellValue(tenKH);

        headerRow = sheet.createRow(3);
        headerRow.createCell(0).setCellValue("Ngày thanh toán");
        headerRow.createCell(1).setCellValue(ngTT);
    }
